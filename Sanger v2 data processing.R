...
target_file <- "sanger_target_metadata_KT_v3.csv" 
...
target_meta2.df <- merge(annotation_targets.df, target_meta.df, by = "Name", sort = FALSE, all.x = TRUE)
...
if (reps == 2){
  GSTmean <- colMeans(GST[,17:ncol(GST)])
}
