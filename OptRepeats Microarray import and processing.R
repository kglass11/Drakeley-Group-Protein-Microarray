...
workdir <- "/Users/Katie/Desktop/R files from work/170518 Optimisation CP3 repeats"
...
#There are no standards printed on these slides, so removing the section for levey jennings plot of std 3
